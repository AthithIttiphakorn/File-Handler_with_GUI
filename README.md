# File Manager Windows Edition : File Organising Solution for Windows

## Key Features of FM:
  - Organize files based on keyword and file type into specfied folders automatically.
  - Configure options using a simple GUI
